...
const AvatarContainer: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          bottom: size === "small" ? "10px" : "44px",
          insetInlineEnd: size === "small" ? "10px" : "36px",
        }}
        className="absolute "
      >
        ...
        <div className="w-full h-full absolute top-0 left-0 overflow-hidden rotate-[60deg]">
          ...
          <div className="w-full h-full absolute top-0 left-0 overflow-hidden rotate-[60deg] ">
            ...
            >
              <div
                style={{
                  width: `${size === "large" ? "103.8px" : "35px"}`,
                  height: `${size === "large" ? "60px" : "20px"}`,
                  top: `${size === "large" ? "3.5px" : "1px"}`,
                  insetInlineStart: `${size === "large" ? "1px" : "0px"}`,
                }}
